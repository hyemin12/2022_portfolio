  ...
  works: [
    ...
    },
    {
      ...
      describtion: [
        ...
        "이 프로젝트를 제작하며 리액트에서 카카오지도 api를 가져와서 사용하는 법과 useRef를 사용하는 법에 대해 공부하였다. 추후에는 다양한 여행들을 확인할 수 있도록 home 화면을 재 구성하고, 지도를 클릭하였을 때 확대/축소하는 버튼이 잘리는 것을 수정 할 것입니다. 또한 보안을 위해 API KEY를 숨기는 방법에 대해 공부할 것입니다.",
      ],
      date: "2022-08-08",
